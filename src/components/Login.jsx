...
import { ArrowLeft, Mail, Lock, Shield, ArrowRight, CheckCircle2, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-[30%] right-[20%] w-[300px] h-[300px] rounded-full bg-indigo-500/5 blur-[80px]" />
      </div>
      ...
      <motion.button
        ...
        className="absolute top-6 left-6 z-10 flex items-center space-x-2 text-slate-400 hover:text-white transition-colors duration-200 group"
      >
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center z-10 relative">
        ...
        <div className="lg:col-span-5 hidden lg:flex flex-col justify-center text-left space-y-6 pr-8">
          ...
          >
            ...
            <span className="font-bold text-2xl tracking-tight text-white">EduFlow AI</span>
          </motion.div>
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h1 className="text-3xl font-extrabold tracking-tight leading-tight text-slate-100">
              Simplify Your <br />
              Teaching Workflow.
            </h1>
        ...
        <motion.div
          ...
          className="lg:col-span-7 bg-slate-900/60 backdrop-blur-xl border border-slate-800/80 rounded-2xl p-6 sm:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.3)]"
        >
            ...
            {!isSuccess ? (
              ...
              >
                <div className="text-center sm:text-left">
                  <h2 className="text-2xl font-bold text-white flex items-center justify-center sm:justify-start gap-2">
                    Welcome Back <Sparkles className="w-5 h-5 text-indigo-400 animate-pulse" />
                  </h2>
                  <p className="text-sm text-slate-400 mt-1">Please select your role and sign in.</p>
                </div>
                ...
                <motion.p
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="text-xs text-indigo-400 bg-indigo-950/20 border border-indigo-500/10 rounded-lg p-2.5 text-center"
                >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-1.5 text-left">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        } rounded-xl py-3 pl-10 pr-4 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-all duration-150`}
                      />
                    </div>
                    {errors.email && (
                      <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-xs text-rose-400">
                        {errors.email}
                      </motion.p>
                    )}
                  </div>
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full relative overflow-hidden bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-800 text-white font-semibold rounded-xl py-3 text-sm shadow-lg hover:shadow-indigo-600/20 active:scale-[0.99] transition-all duration-150 flex items-center justify-center space-x-2 mt-6 cursor-pointer"
                  >
                    {isLoading ? (
                ...
                <div className="grid grid-cols-3 gap-3">
                  <button className="flex items-center justify-center py-2.5 border border-slate-800 rounded-xl bg-slate-950/40 hover:bg-slate-950/80 hover:border-slate-700 transition-colors focus:outline-none">
              ...
              >
                ...
                <div className="space-y-1">
                  <h3 className="text-xl font-bold text-white">Sign In Successful</h3>
                  <p className="text-sm text-slate-400">Welcome to your dashboard. Redirecting...</p>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
